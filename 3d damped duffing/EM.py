...
em_param = param.em(tol = 1e-3, burninpaths = 10, mcmcpaths = 100, numsubintervals = 10, niter = 100, dt = (allt[0, 1] - allt[0, 0]))
"""
...
# save to file
with open('./varying_subintervals/results/subint_9.pkl','wb') as f:
