...
"""
# ic = np.array([[1., 1., 1.], [8.2, 4.1, 1.3], [5.3, 2.2, 0.9], [7.2, -1.8, 2.1], [-0.9, -1.4, 0.4], [0.6, 0.9, -1.8], [-6., 2.3, 4.5], [-0.2, -2.9, 1.4], [3.5, 2.6, -0.5], [0.2, 0., 1.2], [-1.5, 0.6, 3.4], [6.7, 2.2, 4.5]])
...
# save to file
import pickle
with open('./data/nem_3D_lorenz.pkl','wb') as f:
