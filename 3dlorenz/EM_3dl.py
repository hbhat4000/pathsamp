...
x = allx[:, :, :] # picking every 10th term to get a total of 101 time points
t = allt[:, :]

data_param = prm.data(theta = 0.01 * np.random.rand(prm.dof, prm.dim), gvec = sim_param.gvec)
...
print("\n Estimated ordinary: ", estimated_theta.ordinary, "\n True ordinary: ", true_theta.ordinary)

print("\n Estimated hermite: ", estimated_theta.hermite, "\n True hermite: ", true_theta.hermite)
