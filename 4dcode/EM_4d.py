...
error_list, theta_list, gammavec_list, avg_ar_burnin, avg_ar_sampling = em(x, t, em_param, data_param)
time_taken = time.time() - start_time
print("Time taken for 4D EM: ", time_taken)
print("Average AR burnin: ", avg_ar_burnin, ", average AR sampling: ", avg_ar_sampling)
