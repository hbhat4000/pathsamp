...
allx = allx[:, 0::100, :] # picking every 100th term to get a total of 11 time points
allt = allt[:, 0::100] # 11 time points, coarse data
...
with open('./varying_subintervals/subint_' + str(parvalue) + '.pkl','wb') as f:
    pickle.dump([error_list, theta_list, estimated_theta, true_theta, errors, em_param, data_param, euler_param, sim_param], f)
