...
sim_param = prm.system(alpha = 1., beta = -1., gamma = 0.5, delta = -0.3, omega = 1.2, gvec = np.full(prm.dim, noise_mapping[parvalue]))

# create paths
numpaths = 10
ic = np.random.uniform(low=-2.0, high=2.0, size=(numpaths, prm.dim))
