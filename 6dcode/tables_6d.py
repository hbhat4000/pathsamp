...
for test in test_names:
	...
	for i in range(2, 11):
		...
		if (test == './varying_subintervals/tp_11/subint_' or test == './varying_num_timeseries/ts_'):
			parvalue = i
		print(test+str(parvalue))
		with open(test + str(parvalue) + '.pkl', 'rb') as f:
			_, _, _, _, _, _, _, errors, em_param, _, _, sim_param = pickle.load(f)
		meta_list.append((errors, em_param, sim_param))
...
with open('results_6d.pkl','wb') as f:
